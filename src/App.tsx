...
const App: React.FC = () => {
  ...
  //     `Czy mogę wykonać ten przepis: ${plan} bazując na składnikach, które mam w moim spichlerzu: ${products}. Sprawdź dokładnie to co mam i czy zgadza się z tym czego wymaga przepis, zwróć krótkie info Mogę lub nie mogę. Jeśli w ${products} nic mie ma zwróć info: 'TWÓJ SPICHLERZ JEST PUSTY MÓJ PANIE`,
