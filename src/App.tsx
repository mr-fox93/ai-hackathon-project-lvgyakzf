				...
				<div className={styles.mainWrapper}>
					...
					<div className={styles.buttonsWrapper}>
						...
						<div className={styles.dropdownWrapper}>
							{dropdownVisible && (
								<div>
									<button onClick={handleGenerateHealthyMeal}>ZDROWE JEDZONKO</button>
									<button onClick={handleGenerateMealPlan}>JADŁOSPIS NA CAŁY DZIEŃ</button>
									<button onClick={handleGenerateBreakfast}>SMACZNE ŚNIADANKO</button>
